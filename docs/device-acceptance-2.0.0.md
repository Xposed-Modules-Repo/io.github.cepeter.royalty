...
| Telegram 12.8.3 hook signatures, including `onInterceptTouchEvent` | Pending final APK test |
...
| Five ActionBar taps reveal/conceal and redraw | Pending final APK test |
